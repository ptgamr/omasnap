...
constexpr DecisionCase kDecisionCases[] = {
    ...
    {"live holder is left alone when picking a recording target",
     InstanceLockProbe::HeldByOther, InstanceHolder::Alive,
     InstanceMode::RecordTarget, InstanceAction::ReportBusy},
    {"dead holder clears the stale lock for a recording target",
     InstanceLockProbe::HeldByOther, InstanceHolder::Dead,
     InstanceMode::RecordTarget, InstanceAction::ClearStaleLock},
    {"free lock proceeds for a recording target",
     InstanceLockProbe::Acquired, InstanceHolder::Unknown,
     InstanceMode::RecordTarget, InstanceAction::Proceed},
